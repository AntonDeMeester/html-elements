...
def test_htmx_extension():
    ...
    assert c.to_html(format=False) == '<base hx-get="get" hx-post="post" hx-on-click="do" hx-on-test="something" hx-push-url="true" hx-select="this" hx-select-oob="this" hx-swap="innerHTML" hx-swap-oob="this" hx-target="this" hx-trigger="this" hx-vals="something" hx-boost="true" hx-confirm="please" hx-delete="there" hx-disable hx-disabled-elt="please" hx-disinherit="true" hx-encoding="nice" hx-ext="test" hx-headers="test" hx-history="true" hx-history-elt hx-include="name" hx-indicator="#test" hx-params="hello" hx-patch="there" hx-preserve="please" hx-prompt="nooo" hx-put="there" hx-replace-url="true" hx-request="there" hx-sse="deprecated" hx-sync="there" hx-validate="true" hx-vars="some" hx-ws="deprecated"></base>'
